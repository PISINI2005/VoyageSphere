...
public class ComplaintController {
    ...
    public ResponseEntity<ComplaintResponseDTO> createComplaint(@RequestBody @Valid ComplaintRequestDTO dto) {
        ...
        auditLogService.logAction(AuditActions.CREATE_COMPLAINT, AuditEntity.COMPLAINT, null, authUser.currentOrNull(), LogType.INFO);
    ...
    public ResponseEntity<ComplaintResponseDTO> updateStatus(@PathVariable Long id,
        ...
        auditLogService.logAction(AuditActions.UPDATE_COMPLAINT_STATUS, AuditEntity.COMPLAINT, id, authUser.currentOrNull(), LogType.INFO);
